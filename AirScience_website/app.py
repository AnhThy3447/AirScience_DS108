...
from models.predict import input_preprocessing, predict_price, threshold_predicted
app = Flask(__name__)
    ...
    if request.method == "POST":
        ...
        with open(file_path, mode="w", newline="", encoding="utf-8") as file:
            ...
            if not file_exists or os.stat(file_path).st_size == 0:
                writer.writerow(["brand", "hand_luggage", "checked_baggage", "start_hour", "start_day", "destination"])
            writer.writerow([
        ...
        has_result_1 = crawl_planetrip(url, brand) # planetrip_raw.csv
        has_result_2 = filter_user_inputs() # planetrip_filtered.csv
        has_result_3 = preprocess_planetrip() # planetrip_preprocessed.csv
...
def result():
    ...
    flights_with_pred = flights_df.merge(result_df[['flight_id', 'cheap_pred']], on='flight_id', how='left')
